...
<body>
	<div class="body">
	    <div class="header">
	        ...
	        <div class="searchbox"><span class="material-symbols-outlined" style="font-size: 25px; font-weight: bold">search</span></div>
	    </div>
	    	<div class="banner">
		    ...
		    <div class="main">
		        ...
		        <div class="newslist">
		            ...
		            <div class="list">
		                ...
		                <h4>RSG PH are the new champions of MPL PH Season 9</h4>
		                </a>
		                <?php 
