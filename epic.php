<?php 
	...
	$e1 = 'https://www.youtube.com/embed/tK3bKLcWsRQ';
	$e2 = 'https://www.youtube.com/embed/cbbqh0K7sJI';
	$e3 = 'https://www.youtube.com/embed/cbbqh0K7sJI';
	$e4 = 'https://www.youtube.com/embed/tK3bKLcWsRQ';
	$e5 = 'https://www.youtube.com/embed/tK3bKLcWsRQ';
	$e6 = 'https://www.youtube.com/embed/cbbqh0K7sJI';
	$e7 = 'https://www.youtube.com/embed/cbbqh0K7sJI';
	$e8 = 'https://www.youtube.com/embed/tK3bKLcWsRQ';
...
<body>
	<div class="body">
	    ...
	    <div class="miyahead" style="margin-top: 30px"><a href="<?php echo $epic_address; ?>" style="color: white"><?php echo 'Watch Now! Epic Moments o f MLBB Heroes'; ?></a></div>
	        ...
	        <iframe style="max-width: 45%" src="<?php echo $e4; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" "&autoplay=1" allowfullscreen ></iframe>
	        <iframe style="max-width: 45%" src="<?php echo $e5; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" "&autoplay=1" allowfullscreen ></iframe>
